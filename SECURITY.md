...
Operational artifacts generated by StacksOrbit (for example, deployment manifests under `deployment/` or `.stacksorbit/`) should be treated as local-only outputs and must not be committed.
