...
Operational artifacts generated by ConxiusOrbit (for example, deployment manifests under `deployment/` or `.conxius_orbit/`) should be treated as local-only outputs and must not be committed.
