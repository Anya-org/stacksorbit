StacksOrbit is intended to be a public-facing Stacks / Clarity deployment tool.
...
- Never commit runtime deployment artifacts (manifests / histories under `deployment/` or `.stacksorbit/`).
- Ensure release automation references the canonical documentation site (`https://conxian.github.io/stacksorbit/`).
