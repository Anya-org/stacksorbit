...
5. **Monitoring & verification**
   - Monitoring (CLI): `conxius_orbit monitor --follow`.
   - Dashboard (TUI): `conxius_orbit monitor --dashboard` (Textual UI).
   - Verification: `conxius_orbit verify --comprehensive`.
   - Diagnostics: `conxius_orbit diagnose --verbose`.
...
- **Example CLI sequence (testnet):**
  - Dry run:
    - `conxius_orbit deploy --dry-run --category core`
    - `conxius_orbit deploy --dry-run --category tokens`
    - `conxius_orbit deploy --dry-run --category oracle`
    - `conxius_orbit deploy --dry-run --category dimensional`
    - `conxius_orbit deploy --dry-run --category dex`
  - Deploy:
    - `conxius_orbit deploy --category core`
    - `conxius_orbit deploy --category tokens`
    - `conxius_orbit deploy --category oracle`
    - `conxius_orbit deploy --category dimensional`
    - `conxius_orbit deploy --category dex`
  - Monitor / verify:
    - `conxius_orbit monitor --follow`
    - `conxius_orbit verify --comprehensive`
...
- **Verification stage** (`DeploymentVerifier`, `conxius_orbit verify`):
  - Can include:
...
3. **Post‑deployment verification**:
   - `conxius_orbit verify --comprehensive` + custom checks against:
