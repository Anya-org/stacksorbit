...
1. **Clone the Repository:**
    ...
    ```bash
    git clone https://github.com/Conxian/stacksorbit.git
    cd stacksorbit
    ```
...
If you're still having trouble, please open an issue on the [GitHub repository](https://github.com/Conxian/stacksorbit/issues).

## 7. Contributing

### 7.1. Reporting Bugs

1. Check if the bug has already been reported in [Issues](https://github.com/Conxian/stacksorbit/issues)
2. If not, create a new issue with a clear title, description, and steps to reproduce.

### 7.2. Suggesting Features

1. Check [Discussions](https://github.com/Conxian/stacksorbit/discussions) for existing suggestions.
