...
def test_validate_stacks_address_mainnet():
    ...
    assert (
        validate_stacks_address("SP2J1BCZK8Q0CP3W4R1XX9TMKJ1N1S8QZ7K0B5N8", "mainnet")
        is True
    )
    # Testnet address on mainnet should fail
    assert (
        validate_stacks_address("ST1PQHQKV0RJXZFY1DGX8MNSNYVE3VGZJSRTPGZGM", "mainnet")
        is False
    )
    # Short address
    ...
    assert (
        validate_stacks_address("SP2J1BCZK8Q0CP3W4R1XX9TMKJ1N1S8QZ7K0B5N8I", "mainnet")
        is False
    )
...
def test_validate_stacks_address_testnet():
    ...
    assert (
        validate_stacks_address("ST1PQHQKV0RJXZFY1DGX8MNSNYVE3VGZJSRTPGZGM", "testnet")
        is True
    )
    # Mainnet address on testnet should fail
    assert (
        validate_stacks_address("SP2J1BCZK8Q0CP3W4R1XX9TMKJ1N1S8QZ7K0B5N8", "testnet")
        is False
    )
    # Devnet should work same as testnet
    assert (
        validate_stacks_address("ST1PQHQKV0RJXZFY1DGX8MNSNYVE3VGZJSRTPGZGM", "devnet")
        is True
    )
